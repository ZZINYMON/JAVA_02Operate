...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        * 필기.
        *  논리 연산자의 종류
        *  1. 논리 연결 연산자 : 두 개의 피연산자를 가지는 이항 연산자이며, 연산자의 결항 방향은 왼쪽에서 오른쪽이다.
        *                      두 개의 논리식을 판단하여 참과 거짓을 판단한다.
        *  1-1. &&(논리 AND)연산자 : 두 개의 논리식 모두 참일 경우 참을 반환, 둘 중 한 개라도 거짓인 경우 거짓을 반환하는 연산자이다.
        *  1-2. ||(논리 OR)연산자 : 두 개의 논리식 중 둘 중 하나라도 참일 경우 참을 반환, 둘 다 모두 거짓인 경우 거짓을 반환한다.
        ...
        *
        ...
        System.out.println("false와 false의 논리 or 연산 : " + (false || true));
        ...
        System.out.println(a < b || c < d); // 둘 중 하나라도 t=t 인데, 둘 다 t 이므로 t
        System.out.println(a < b || c > d); // 둘 중 하나라도 t=t
        System.out.println(a > b || c < d); // 둘 중 하나라도 t=t
        System.out.println(a > b || c > d); // 둘 다 모두 f이므로 f
